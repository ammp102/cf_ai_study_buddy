/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7f93753cb31ded0b859798b9597aae85)
// Runtime types generated with workerd@1.20260301.1 2026-03-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "ChatAgent" | "FlashcardDO" | "QuizDO";
	}
	interface Env {
		AI: Ai;
		ChatAgent: DurableObjectNamespace<import("./src/server").ChatAgent>;
		FLASHCARD_DO: DurableObjectNamespace<import("./src/server").FlashcardDO>;
		QUIZ_DO: DurableObjectNamespace<import("./src/server").QuizDO>;
	}
}
